    ...
    with gr.Blocks() as demo:
        with gr.Row():
            ...
            with gr.Column(scale=5):
                ...
                with gr.Tab("推理参数管理"):
                    custom_infer_parameters = gr.Textbox(label="custom_infer_parameters", lines=3, value=get_custom_infer_parameters)
        ...
        check_template_content.click(check_template_content_func, inputs=[prompt_declare_file, template_name], outputs=[generated_prompt])
        generate_mock_user_parameters.click(generate_mock_user_parameters_func, inputs=[prompt_declare_file, template_name], outputs=[user_parameters])
